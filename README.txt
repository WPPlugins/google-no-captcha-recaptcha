...
= 4.0.4 =
* Renamed pot file to google-nocaptcha-recaptcha-locale. Thanks to @otinanaipali issue# https://wordpress.org/support/topic/unable-to-translate-error-messages.
